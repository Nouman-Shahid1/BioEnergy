...
import hala from "../../../public/images/hala.png";
...
const UpdatePage = () => {
  ...
  keywords="wood pellets pakistan, biomass fuel, energybi, sindhu pradeep, bioenrgy coe, bio fuel, sindhu jose, biofuels, bioenergy products, industrial heating fuel, clean fuel alternative, sindh wood fuel, boiler fuel, لکڑی کی گولیاں, بایوماس فیول, متبادل ایندھن, صنعتی ایندھن, صاف توانائی کے حل, سندھ میں لکڑی کا ایندھن"
/>
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl px-6 sm:px-8 md:px-20 py-20 sm:py-32 md:py-48 text-left">
          <p
  className={`text-white text-2xl sm:text-xl font-medium leading-[1.7] mb-6 ${poppins.className}`}
>
  Project Overview
</p>
