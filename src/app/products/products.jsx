...
const ProductPage = () => {
  ...
  keywords="wood pellets pakistan, biomass fuel, biogas, biomass energy, bioenergy products, industrial heating fuel, clean fuel alternative, sindh wood fuel, boiler fuel, لکڑی کی گولیاں, بایوماس فیول, متبادل ایندھن, صنعتی ایندھن, صاف توانائی کے حل, سندھ میں لکڑی کا ایندھن"
/>
