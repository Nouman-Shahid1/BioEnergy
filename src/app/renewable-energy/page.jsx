...
const Home = () => {
  return (
    <div className="font-inter antialiased text-gray-800 bg-white">
      {/* Hero Section */}
      <section
        className="relative min-h-[80vh] bg-cover bg-center flex items-center justify-center text-white"
        style={{
          backgroundImage:
            "url('https://bioenergy.com.pk/wp-content/uploads/2023/10/C-scaled.webp')",
        }}
      >
        ...
        <div className="relative z-10 text-center px-4">
          <h1
            className={`text-4xl sm:text-5xl md:text-6xl lg:text-[113.611px] leading-tight text-white uppercase font-bold tracking-tight ${economica.className}`}
          >
            RENEWABLE ENERGY
          </h1>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        ...
        {/* Energy In World */}
        <section className="flex flex-col md:flex-row items-center gap-8 sm:gap-12 mb-16">
          <div className="md:w-1/2">
        ...
        {/* Heat Energy */}
        <section className="flex flex-col-reverse md:flex-row items-center gap-8 sm:gap-12 mb-16">
          <div className="md:w-1/2 w-full">
            <img
              src="/images/energy3.png"
              alt="Heat Energy"
          ...
          <div className="md:w-1/2">
            ...
            <p className="text-gray-700 mb-4">
              Heat energy is a basic utility in everyday life. It is a must
              requirement in daily food preparation, industrial processing, and
              various manufacturing and commercial activities.
            </p>
            <p className="text-gray-700">
              The reliance on fossil fuels is continuously declining. The world
              is seeking alternatives like biomass fuels to get heat energy
              reliably, sustainably, and cost-efficiently.
            </p>
          </div>
        </section>
        ...
        <section className="flex flex-col md:flex-row items-center gap-8 sm:gap-12 mb-16">
          <div className="md:w-1/2">
            ...
            <p className="text-gray-700 mb-4">
              The energy crisis is a global issue caused by a limited supply of
              energy, leading to increased prices and reduced availability.
            </p>
            <p className="text-gray-700">
              Developing countries lack enough resources, while even developed
              nations face crises due to political and climate factors.
            </p>
          </div>
          <div className="md:w-1/2 w-full">
            <img
        ...
        {/* Helping World To Grow Sustainably */}
        <section className="flex flex-col md:flex-row items-center gap-8 sm:gap-12">
          <div className="md:w-1/2">
            <h2 className="text-2xl sm:text-3xl font-semibold text-green-600 mb-4">
              Helping World To Grow Sustainably
            </h2>
            <p className="text-gray-700 mb-4">
              With an increasing population and declining resources, we face
              crises in energy, carbon emissions, and pollution.
            </p>
            <p className="text-gray-700 mb-4">
              We ensure clean energy, responsible consumption, and economic
              growth by converting waste materials to usable energy sources.
            </p>
            <p className="text-gray-700 mb-4">
              We help industries avoid shutdowns and support GDP expansion,
              creating a balance of payments and sustainability.
            </p>
            <p className="text-gray-700">
              We also reduce deforestation by offering fuel alternatives, aiding
              climate action, and supporting global development goals.
            </p>
          </div>
          <div className="md:w-1/2 flex justify-center">
            <img
              src="/images/BN.png"
              alt="Sustainable Goals"
              className="rounded-full shadow-lg w-64 h-64 sm:w-80 sm:h-80 object-cover"
            />
          </div>
        </section>
      </main>
