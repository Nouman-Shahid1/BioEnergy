...
// const Footer = () => {
//   return (
//     <footer className="relative bg-[#003300] text-white py-12 px-4 md:px-8 lg:px-16 overflow-hidden">
//       {/* Background Overlay */}
//       <div
...
//               <span>info@bioenergy.com.pk</span>
//             </div>
//           </div>
...
//               <Link href="/about-us" className="text-sm hover:text-gray-300 transition-colors">
//                 About Us
//               </Link>
//               <Link href="/products" className="text-sm hover:text-gray-300 transition-colors">
//                 Products
//               </Link>
//               <Link href="/renewable-energy" className="text-sm hover:text-gray-300 transition-colors">
//                 Renewable Energy
//               </Link>
...
//           {/* Section 3: Follow Us */}
//           <div className="space-y-4">
//             <h3 className="text-lg font-semibold border-b border-gray-600 pb-2">Follow Us</h3>
...
//           © 2023. All rights reserved. Pak Bioenergy
//         </div>
//       </div>
//     </footer>
//   );
        ...
        <div className="relative z-10 container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start text-sm mt-4">
                <FaMapMarkerAlt className="mr-2 mt-1 flex-shrink-0" />
                <span> Site Sindh Bio Energy Lakhat Road Tando Muhammad Khan</span>
              </div>
              <div className="flex items-center text-sm mt-2">
                <FaPhoneAlt className="mr-2" />
                <span>03453777766</span>
            ...
            <div className="space-y-4">
              ...
              {/* Our Team */}
              <h3 className="text-lg font-semibold border-b border-gray-600 pb-2 mt-6">Our Team</h3>
              <div className="flex space-x-4">
                <div className="text-center">
                  <img
                    src="/images/pic2.jpg"
